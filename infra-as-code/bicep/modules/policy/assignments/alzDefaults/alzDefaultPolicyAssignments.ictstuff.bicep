...
/*  This policy should not be assigned, as there is no separate platform identity subscription
...
var varManagementGroupIds = {
  ...
  platformManagement: '${parTopLevelManagementGroupPrefix}-platform${parTopLevelManagementGroupSuffix}'
  platformConnectivity: '${parTopLevelManagementGroupPrefix}-platform${parTopLevelManagementGroupSuffix}'
  platformIdentity: '${parTopLevelManagementGroupPrefix}-platform${parTopLevelManagementGroupSuffix}'
